...
export const ROLES = [
  ...
  },
  {
    ...
    initials: 'PS',
    description: 'Review patient status, manage care plans, and approve clinical decisions with clarity.',
...
export const PATIENTS = [
  {
    ...
    assignedNurseUserId: 'user-nurse',
    assignedDoctorUserId: 'user-doctor',
...
export const APPOINTMENTS = [
  ...
  { id: 'apt4', patientId: 'MED-ELR-24012', patient: 'Ana Rodrigues', type: 'Nurse Follow-up', clinician: 'Nurse Elena Costa', date: '2026-06-26', time: '2:00 PM', mode: 'in-person', status: 'scheduled' as AppointmentStatus, reason: 'Missed visit follow-up and adherence review', duration: 30, location: 'Suite 2, Elara WSC' },
...
export const MEDICATIONS = [
  { id: 'med1', name: 'Ferrous Sulfate', dosage: '200mg', frequency: 'Twice daily', route: 'Oral', instructions: 'Take with water after meals. Avoid taking with dairy products or antacids.', startDate: '2026-04-01', endDate: '2026-10-14', prescribedBy: 'Dr. Priya Sharma', prescribedByUserId: 'user-doctor', scheduleTimes: ['08:00', '20:00'], adherence: 91, missedDoses: 4, lastTaken: '2026-06-25T08:00:00', notes: 'Monitor for GI discomfort. Dark stool is normal.', patientId: 'MED-ELR-24018', hospitalId: 'ELR' },
  { id: 'med2', name: 'Folic Acid', dosage: '400mcg', frequency: 'Once daily', route: 'Oral', instructions: 'Take in the morning with breakfast.', startDate: '2026-02-01', endDate: '2026-10-14', prescribedBy: 'Dr. Priya Sharma', prescribedByUserId: 'user-doctor', scheduleTimes: ['07:30'], adherence: 97, missedDoses: 1, lastTaken: '2026-06-25T07:30:00', notes: 'Continue throughout pregnancy.', patientId: 'MED-ELR-24018', hospitalId: 'ELR' },
  { id: 'med3', name: 'Calcium Carbonate', dosage: '500mg', frequency: 'Once daily', route: 'Oral', instructions: 'Take in the evening. Do not take at the same time as iron supplements.', startDate: '2026-04-01', endDate: '2026-10-14', prescribedBy: 'Dr. Priya Sharma', prescribedByUserId: 'user-doctor', scheduleTimes: ['21:00'], adherence: 85, missedDoses: 8, lastTaken: '2026-06-24T20:00:00', notes: 'Space at least 2 hours apart from iron.', patientId: 'MED-ELR-24018', hospitalId: 'ELR' },
  { id: 'med4', name: 'Vitamin D3', dosage: '1000 IU', frequency: 'Once daily', route: 'Oral', instructions: 'Take with a meal containing fat for better absorption.', startDate: '2026-04-01', endDate: '2026-10-14', prescribedBy: 'Dr. Priya Sharma', prescribedByUserId: 'user-doctor', scheduleTimes: ['07:30'], adherence: 88, missedDoses: 6, lastTaken: '2026-06-25T07:30:00', notes: 'Check levels at 28-week visit.', patientId: 'MED-ELR-24018', hospitalId: 'ELR' },
  { id: 'med5', name: 'Prenatal Multivitamin', dosage: '1 tablet', frequency: 'Once daily', route: 'Oral', instructions: 'Take with breakfast each morning.', startDate: '2026-05-01', endDate: '2026-10-28', prescribedBy: 'Nurse Elena Costa', prescribedByUserId: 'user-nurse', scheduleTimes: ['08:00'], adherence: 72, missedDoses: 5, lastTaken: '2026-06-24T08:00:00', notes: 'Follow-up on adherence at next nurse visit.', patientId: 'MED-ELR-24012', hospitalId: 'ELR' },
  { id: 'med6', name: 'Low-Dose Aspirin', dosage: '75mg', frequency: 'Once daily', route: 'Oral', instructions: 'Take in the evening with food.', startDate: '2026-06-01', endDate: '2026-10-28', prescribedBy: 'Nurse Elena Costa', prescribedByUserId: 'user-nurse', scheduleTimes: ['20:00'], adherence: 80, missedDoses: 3, lastTaken: '2026-06-25T20:00:00', notes: 'Monitor for bruising at next review.', patientId: 'MED-ELR-24012', hospitalId: 'ELR' },
];
